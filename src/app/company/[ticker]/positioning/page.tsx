 ...
 * Positioning Page
 *
 * Shows short interest, options flow, and market sentiment.
 */
...
export async function generateMetadata(props: Props) {
  ...
  return {
    title: `${ticker.toUpperCase()} Positioning | Company Analysis`,
  };
}

export default async function PositioningPage(props: Props) {
  const { ticker } = await props.params;
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="p-12 bg-yellow-500/10 border border-yellow-500/20 rounded-lg text-center">
          ...
          <p className="text-yellow-200/70">
            This tab will show short interest, options flow, IV rank, and market sentiment.
          </p>
        </div>
      </div>
    </div>
