 ...
 * Report Page
 *
 * One-page tear sheet for printing/sharing.
 */
...
export async function generateMetadata(props: Props) {
  ...
  return {
    title: `${ticker.toUpperCase()} Report | Company Analysis`,
  };
}
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="p-12 bg-yellow-500/10 border border-yellow-500/20 rounded-lg text-center">
          ...
          <p className="text-yellow-200/70">
            This tab will show a one-page tear sheet summarizing all analysis for printing/sharing.
          </p>
        </div>
      </div>
    </div>
